...
export default function ClientDashboard() {
  const [activeTab, setActiveTab] = useState(
    () => localStorage.getItem("clientActiveTab") || "home",
  );
  ...
  return (
    <div
      className={`min-h-screen bg-brand-surface font-sans selection:bg-brand-primary selection:text-white flex`}
    >
        ...
        <main className="flex-1 bg-brand-surface-container overflow-y-auto">
          {activeTab === "home" ? (
            ...
            <div className="flex flex-col items-center justify-center h-[calc(100vh-144px)] text-brand-text-variant">
              ...
              <h3 className="text-2xl font-semibold text-brand-text-main mb-2">
                Coming Soon!
              </h3>
              <p className="text-sm font-medium">
                The {activeTab} section is currently under construction.
              </p>
            </div>
          )}
        </main>
