...
export default function SignupPage() {
  ...
  const idFrontInputRef = React.useRef(null);
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (
        accountType === "provider" &&
        (formData.idFrontFile || formData.selfieFile)
      ) {
  ...
  const addCustomService = () => {
    if (
      customService.trim() &&
      !formData.services.includes(customService.trim())
    ) {
      setFormData({
        ...formData,
  ...
  return (
    <div className="min-h-screen bg-brand-surface-container flex flex-col justify-center items-center p-6 py-20">
              ...
              <div className="space-y-8 overflow-y-auto max-h-[60vh] pr-4 custom-scrollbar">
                <section className="space-y-3">
                  <h3 className="font-bold text-brand-text-main flex items-center gap-2">
                    <Shield size={16} className="text-brand-primary" /> 1.
                    Platform Trust & Safety
                  </h3>
                  <p className="text-xs text-brand-text-variant leading-relaxed font-medium">
                    Lingkod Hub is a professional marketplace. Users are
                    strictly prohibited from utilizing the platform to lure,
                    harass, or endanger providers. Any attempt to solicit
                    services for illegal activities, or to use the platform as a
                    front for malicious intent, will result in immediate
                    permanent account termination and coordination with local
                    law enforcement.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li
                        key={i}
                        className="text-[11px] text-brand-text-variant flex gap-2 font-medium"
                      >
                ...
                <section className="space-y-3">
                  <h3 className="font-bold text-brand-text-main flex items-center gap-2">
                    <Lock size={16} className="text-brand-primary" /> 3. Data
                    Privacy & Vulnerabilities
                  </h3>
                  <p className="text-xs text-brand-text-variant leading-relaxed font-medium">
                    We employ enterprise-grade encryption. However, users are
                    responsible for maintaining the confidentiality of their
                    credentials. Users must report any suspected system
                    vulnerabilities or unauthorized access immediately.
                    Exploiting or attempting to probe system vulnerabilities is
                    an offense that leads to an irrevocable ban.
                  </p>
                </section>

                <section className="space-y-3">
                  <h3 className="font-bold text-brand-text-main flex items-center gap-2">
                    <CheckCircle size={16} className="text-brand-primary" /> 4.
                    Payment Integrity
                  </h3>
                  <p className="text-xs text-brand-text-variant leading-relaxed font-medium">
                    Payments must be processed via the platform to ensure the
                    24-hour dispute window remains valid. Direct payments
                    outside Lingkod Hub remove our ability to assist in cases of
                    service failure or fraud.
                  </p>
                </section>
                ...
                <div className="p-6 bg-brand-primary/5 rounded-2xl border border-brand-primary/10">
                  <p className="text-[10px] text-brand-primary font-bold text-center uppercase tracking-widest leading-relaxed">
                    By clicking "I Agree", you acknowledge that Lingkod Hub
                    reserves the right to suspend or ban users without prior
                    notice if professional standards are breached.
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  ...
                  <p className="text-sm text-brand-text-variant">
                    Select all the skills you can offer to clients
                  </p>
                </div>
                <button
                  type="button"
      ...
      <Link to="/" className="fixed top-8 left-8 flex items-center gap-3 z-50">
        ...
        <span className="text-2xl font-bold tracking-tight text-brand-text-main">
          Lingkod Hub
        </span>
      </Link>
          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-brand-text-main mb-4">
                  {t("auth", "regSuccess")}
                </h2>
              ...
              <motion.div key="form">
                <div className="text-center mb-8">
                  <h1 className="text-3xl font-bold text-brand-text-main mb-2">
                    {accountType === "provider"
                      ? t("auth", "signupHeaderProvider")
                      : t("auth", "signupHeaderClient")}
                  </h1>
                            ...
                            <div
                              className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-4 transition-colors ${
                                accountType === "client"
                                  ...
                                  : "bg-brand-surface-container text-brand-text-variant group-hover:bg-brand-primary/10 group-hover:text-brand-primary"
                              }`}
                            >
                              <User size={24} />
                            </div>
                            <h3 className="font-bold text-brand-text-main mb-1">
                              {t("auth", "hireTitle")}
                            </h3>
                            <p className="text-[10px] text-brand-text-variant font-medium leading-relaxed">
                              {t("auth", "hireDesc")}
                            </p>
                          </button>
                          <button
                            ...
                            <div className="pt-2">
                              <label className="flex items-start gap-3 p-4 bg-brand-surface-container border border-brand-outline rounded-2xl cursor-pointer group hover:bg-brand-surface transition-all">
                                ...
                                <div className="text-[11px] font-bold text-brand-text-main leading-relaxed">
                                  ...
                                  and understand platform policies regarding
                          ...
                          <div className="flex flex-col items-center justify-center gap-2 mb-4">
                            <div className="relative w-24 h-24 rounded-full bg-brand-surface-card border-2 border-dashed border-brand-outline flex items-center justify-center overflow-hidden hover:border-brand-primary/50 transition-colors group cursor-pointer">
                              {formData.avatarUrl ? (
                                ...
                                <Camera
                                  size={24}
                                  className="text-brand-text-variant group-hover:text-brand-primary transition-colors"
                                />
                              )}
                              <input
                                type="file"
                            ...
                            <span className="text-xs font-medium text-brand-text-variant">
                      ...
                      >
                        <div className="space-y-4">
                          <div className="flex flex-col items-center justify-center gap-2 mb-4">
                            ...
                            <span className="text-xs font-bold text-brand-text-main uppercase tracking-widest text-center mt-1">
                              Upload Profile Photo
                            </span>
                            <p className="text-[10px] text-brand-text-variant text-center font-medium">
                              Show clients who you are! A professional photo
                              increases your hire rate by 80%.
                            </p>
                          </div>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-brand-text-variant ml-1">
                              Tip: Keep it clear, professional, and friendly.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between items-end ml-1 mb-2">
                              <label className="text-xs font-bold text-brand-text-main uppercase tracking-widest">
                                Services You Offer
                              </label>
                              <button
                                type="button"
                            ...
                            {formData.services.filter(
                              (s) => !COMMON_SERVICES.includes(s),
                            ).length > 0 && (
                              <div className="mt-4 pt-4 border-t border-brand-outline border-dashed">
                                <p className="text-[10px] font-bold text-brand-text-variant uppercase tracking-widest mb-3">
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {formData.services
                                    ...
                                    .map((service) => (
                                      <div
                                        key={service}
                                        className="flex items-center gap-2 bg-brand-primary/5 border border-brand-primary/20 px-3 py-1.5 rounded-lg"
                                      >
                      ...
                      >
                        <div className="p-6 bg-brand-primary/5 border border-brand-primary/20 rounded-3xl">
                          <div className="flex gap-4 mb-4">
                            ...
                            <div>
                              ...
                              <p className="text-[10px] text-brand-text-variant font-medium leading-relaxed mt-1">
                                To maintain a safe community, we require all
                                providers to submit valid government
                                documentation. This data is encrypted and
                        ...
                        <div className="flex gap-4">
                          ...
                          <button
                            ...
                            onClick={nextStep}
                            disabled={
                              !formData.idFrontUrl || !formData.selfieUrl
                            }
                            className="flex-[2] py-4 bg-brand-primary text-white font-bold rounded-2xl shadow-lg shadow-brand-primary/20 hover:bg-[#059669] transition-all disabled:opacity-50"
                          >
                      ...
                      >
                          ...
                          <div>
                            ...
                            <div className="space-y-4">
                              <p className="text-[11px] leading-relaxed text-brand-text-variant font-medium">
                                By registering as a Provider on Lingkod Hub, you
                                explicitly agree to our strict verification and
                              ...
                              <div className="p-3 bg-red-50 border border-red-100 rounded-xl flex gap-3">
                                ...
                                <p className="text-[10px] text-red-600 font-bold leading-relaxed lowercase italic">
                                  Verified criminal history, identity theft, or
                                  platform circumvention (side-deals) will
                                  result in an immediate permanent ban and
                                  forfeiture of all pending earnings.
                                </p>
                              </div>
                              <p className="text-[11px] leading-relaxed text-brand-text-variant font-medium">
                                Providers act as independent contractors. You
                                are responsible for your own safety equipment
                                and specialized tools. Lingkod Hub provides the
                                marketplace and dispute protection but does not
                                act as your direct employer.
                              </p>
                              <ul className="space-y-2">
                                ...
                                <li className="flex items-center gap-2 text-[10px] font-bold text-brand-text-main italic">
                                  <CheckCircle
                                    ...
                                    className="text-[#059669]"
                                  />{" "}
                                  Weekly payouts require verified GCash/Bank
                                  accounts.
                                </li>
                              </ul>
                            </div>
                        ...
                        <label className="flex items-start gap-3 p-4 bg-brand-surface-container border border-brand-outline rounded-2xl cursor-pointer group hover:bg-brand-surface transition-all">
                          ...
                          <span className="text-[11px] font-bold text-brand-text-main leading-relaxed group-hover:text-brand-primary transition-colors">
                            ...
                            , Professional Code of Conduct, and Dispute
                            Resolution Policy.
                          </span>
                        </label>
