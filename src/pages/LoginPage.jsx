        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-sm font-semibold text-brand-text-main">
                {t("auth", "passLabel")}
              </label>
            </div>
            <input
          ...
          <button
            disabled={loading}
            type="submit"
            className="w-full py-3.5 mt-2 bg-brand-primary hover:bg-[#059669] disabled:opacity-50 text-white font-semibold rounded-xl shadow-md shadow-brand-primary/20 transition-all"
          >
