        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <aside className="hidden lg:block w-72 space-y-8">
            <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm space-y-10">
              <div>
                ...
                <div className="space-y-10">
                  {/* Rating Filter */}
                  <div>
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 block">{t('services', 'ratingLabel')}</label>
                  ...
                  {/* Price Range */}
                  <div>
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 block">{t('services', 'priceLabel')}</label>
                  ...
                  {/* Location Filter */}
                  <div>
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4 block">{t('services', 'locationLabel')}</label>
            ...
            <div className="p-8 bg-gray-900 rounded-[2.5rem] text-white relative overflow-hidden group cursor-pointer" onClick={() => navigate('/signup')}>
              ...
              <h4 className="font-bold text-xl mb-3 relative z-10">{t('services', 'partnerTitle')}</h4>
              <p className="text-sm text-gray-400 mb-8 leading-relaxed relative z-10">{t('services', 'partnerDesc')}</p>
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-gray-900">
                {activeCategory === 'all' ? t('services', 'popularLabel') : getCategoryTitle(activeCategory, CATEGORIES.find(c => c.id === activeCategory)?.title || '')}
                <span className="ml-3 text-sm font-medium text-gray-400 uppercase tracking-widest">{filteredOffers.length} {t('services', 'resultsLabel')}</span>
              </h2>
            </div>
                    ...
                    <div className="h-48 relative overflow-hidden">
                      ...
                      <div className="absolute bottom-4 left-4">
                        <span className="bg-black/60 backdrop-blur-md text-white text-[10px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest ring-1 ring-white/20">
                          {getCategoryTitle(offer.category, CATEGORIES.find(c => c.id === offer.category)?.title || '')}
                        </span>
                      </div>
                    </div>
            ...
            {filteredOffers.length === 0 && (
              <div className="py-20 text-center bg-white rounded-[2rem] border-2 border-dashed border-gray-100">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">{t('services', 'emptyTitle')}</h3>
      ...
      <section className="bg-white border-t border-gray-100 py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">{t('services', 'whyTitle')}</h2>
            <p className="text-gray-600 font-medium">{t('services', 'whyDesc')}</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { icon: ShieldCheck, title: t('services', 'feat1Title'), desc: t('services', 'feat1Desc'), color: 'text-blue-500' },
              { icon: Clock, title: t('services', 'feat2Title'), desc: t('services', 'feat2Desc'), color: 'text-brand-primary' },
              { icon: CheckCircle2, title: t('services', 'feat3Title'), desc: t('services', 'feat3Desc'), color: 'text-purple-500' }
            ].map((feature, idx) => (
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto w-full">
        <div className="bg-gray-900 rounded-[3rem] p-12 md:p-20 text-white relative overflow-hidden text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="relative z-10 max-w-xl">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight text-white">{t('services', 'ctaTitle')}</h2>
