...
export const PasswordModal = ({ isOpen, onClose }: PasswordModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Password changed successfully! You will now be logged out for security.');
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-brand-text-main">Change Password</h2>
              </div>
              <button 
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-brand-text-main uppercase tracking-widest">Current Password</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-brand-text-main uppercase tracking-widest">New Password</label>
                <div className="relative">
                  <input 
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold text-brand-text-main uppercase tracking-widest">Confirm New Password</label>
                <input 
                  type="password"
                  required
