          ...
          >
            <div className="p-8 border-b border-brand-outline flex justify-between items-center bg-brand-surface-container/30">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-xl font-bold text-brand-text-main">{activeContent.title}</h2>
              </div>
              <button 
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto p-8 custom-scrollbar">
              ...
              <div className="mt-12 p-6 bg-brand-primary/5 rounded-2xl border border-brand-primary/10 text-center">
                <p className="text-xs text-brand-text-variant font-medium">
                  Last updated: May 14, 2026. For questions regarding these terms, please contact <a href="mailto:legal@lingkodhub.com" className="text-brand-primary hover:underline font-bold">legal@lingkodhub.com</a>.
                </p>
              </div>
            </div>
