                  ...
                  <div className="bg-brand-surface border-2 border-brand-outline rounded-2xl flex flex-col shadow-sm">
                    <div className="flex items-center justify-between p-6 border-b border-brand-outline">
                      <div className="pr-4">
                        ...
                        <p className="text-xs text-brand-text-variant">
                          Receive an email when providers message you.
                        </p>
                      </div>
                  ...
                  <div className="bg-brand-surface border-2 border-brand-outline rounded-2xl flex flex-col shadow-sm">
                    <div className="flex items-center justify-between p-6 border-b border-brand-outline">
                      <div className="pr-4">
                        ...
                        <p className="text-xs text-brand-text-variant">
                          Allow other users to find and view your public profile
                          page.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer outline-none">
                    ...
                    <div className="flex items-center justify-between p-6">
                      <div className="pr-4">
                        ...
                        <p className="text-xs text-brand-text-variant">
                          Show other users when you are currently active on the
                          platform.
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer outline-none">
                ...
                <div>
                  ...
                  {addresses.length === 0 ? (
                    <div className="bg-brand-surface border-2 border-dashed border-brand-outline rounded-2xl p-12 text-center">
                      <MapPin
                        className="mx-auto text-brand-text-variant mb-4 opacity-20"
                        size={48}
                      />
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {addresses.map((addr) => (
                        <div
                          key={addr.id}
                          className={`flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between border-2 rounded-2xl p-6 shadow-sm transition-all ${addr.is_default ? "border-brand-primary bg-brand-primary/5" : "border-brand-outline bg-brand-surface"}`}
                        >
                          <div className="flex items-center gap-4">
                            <div
                              className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${addr.is_default ? "bg-brand-primary/20" : "bg-brand-outline/20"}`}
                            >
                              <MapPin
                                className={
                                  addr.is_default
                            ...
                            <div>
                              <h4 className="text-sm font-semibold text-brand-text-main mb-1 flex items-center gap-2">
                                {addr.label}
                                {addr.is_default === 1 && (
                                  <span className="text-[10px] font-bold uppercase tracking-widest bg-brand-primary text-white px-2 py-0.5 rounded">
                                    Default
                                  </span>
                                )}
                              </h4>
              ...
              {payments.map((p) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 font-medium">
                    {p.job_title} - Payment via {p.payment_method.toUpperCase()}
                  </td>
