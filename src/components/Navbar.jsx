      ...
      >
        <div className="space-y-6 pb-12">
          ...
          <div className="flex justify-between items-center bg-gray-50 p-4 rounded-[2rem] border border-gray-100/60 mb-2">
            <span className="text-xs font-black uppercase tracking-wider text-gray-400 pl-2">
              Wika / Language
            </span>
            <LanguageSwitcher />
          </div>
          ...
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              ...
              >
                ...
                <ChevronRight
                  size={20}
                  className={`${isActive(link.path) ? "text-white" : "text-gray-300"} group-hover:translate-x-1 transition-all`}
                />
              </Link>
            ))}
          </div>
