...
const translations = {
  taglish: {
    ...
    suki: {
      ...
      benefit1Desc:
        "See providers with high repeat booking rates in your barangay.",
      benefit2Title: "Suki Discounts",
      benefit2Desc:
        "Get special rates and priority booking from your favorite partners.",
    ...
    trust: {
      ...
      card1Desc:
        "If something isn't right, handa ang aming team na ayusin ang dispute para sa'yo.",
      card1Tag: "100% Secure",
      card1Detail: "Service Protection",
      card2Title: "Verified Partners",
      card2Desc:
        "Lahat ng providers ay dumaan sa background check at Barangay verification.",
      card2Tag: "Subok na",
      card2Detail: "ID & Background Checked",
      card3Title: "Kausap na Tao",
      card3Desc:
        "Walang bots dito. Local support team ang sasagot sa kahit anong concern mo.",
    ...
    howItWorks: {
      ...
      step1Desc:
        "I-browse ang mga categories o i-search ang specific na tulong na kailangan mo.",
      step2Title: "Pumili ng Suki",
      step2Desc:
        "I-compare ang mga profiles, basahin ang reviews ng mga kapitbahay, at piliin ang swak sa budget.",
      step3Title: "Book & Relax",
      step3Desc:
        "Mag-set ng schedule, magbayad nang safe, at i-enjoy ang trabahong pulido.",
    },
    cta: {
    ...
    footer: {
      ...
      copyright:
        "© 2026 Lingkod Hub Philippines. Ang inyong ka-Suki sa serbisyo.",
    ...
    about: {
      ...
      valTrustDesc:
        "Bawat partner ay dumadaan sa verification process para masigurong ligtas at professional ang ating komunidad.",
      valComm: "Komunidad Muna",
      valCommDesc:
        "Inuuna namin ang pag-unlad ng komunidad sa pamamagitan ng pag-connect sa mga neighborhood experts at mga residente.",
      valQuality: "Kalidad na Serbisyo",
      valQualityDesc:
        "Sinisigurado ng ating review system na ang pinakamagagaling na serbisyo lang ang nangunguna.",
      visionTitle: "Gawa para sa kinabukasan ng lokal na trabaho.",
      visionDesc:
        "Sa pag-unlad ng digital landscape, nagbabago rin ang paraan ng pagtatrabaho. Ang Lingkod Hub ay nagbibigay ng modernong platform para sa mga self-employed partners upang pamahalaan ang kanilang business, makahanap ng bagong suki, at magpatuloy sa pag-asenso.",
      ...
      visionBadgeDesc:
        "Kinilala bilang pinakamabilis lumagong local service marketplace.",
      footerText: "© 2026 Lingkod Hub Philippines. All rights reserved.",
    },
    services: {
      headerTitle: "Anong service ang kailangan mo ngayon?",
      searchPlaceholder:
        "Mag-search ng serbisyo (e.g. 'Aircon cleaning', 'Plumbing')",
      searchBtn: "Hanapin",
      ...
      whyDesc:
        "Ang pinakaligtas at pinakamabilis na paraan para mag-hire ng local partners.",
      feat1Title: "Identity Verified",
      feat1Desc:
        "Lahat ng partners ay dumaan sa background at identity check ng barangay.",
      feat2Title: "Mabilis na Sagot",
      feat2Desc:
        "Makakuha ng quotes at confirmations sa loob ng ilang minuto, hindi araw.",
    ...
    auth: {
      ...
      hireDesc:
        "Naghahanap ako ng professional services para sa aking bahay o business.",
      workTitle: "Maghanap ng Trabaho",
      workDesc:
        "Gusto kong i-alok ang aking skills at kumita bilang verified provider.",
      ...
      tosAgree:
        "Sumasang-ayon ako sa Terms of Service at patakaran ng platform.",
      tosLink: "Terms of Service",
      regSuccess: "Matagumpay ang iyong Registration!",
      redirecting:
        "Welcome sa Lingkod Hub. Dinidirekta ka na sa iyong dashboard...",
  ...
  english: {
    ...
    suki: {
      ...
      benefit1Desc:
        "See providers with high repeat booking rates in your neighborhood.",
    ...
    trust: {
      ...
      card1Desc:
        "If something isn't right, our team is ready to resolve the dispute for you.",
      card1Tag: "100% Secure",
      card1Detail: "Service Protection",
      card2Title: "Verified Partners",
      card2Desc:
        "All service providers undergo background checks and Barangay verification.",
      card2Tag: "Tested",
      card2Detail: "ID & Background Checked",
      card3Title: "Real Human Support",
      card3Desc:
        "No bots here. Our local support team is ready to answer any of your concerns.",
    ...
    howItWorks: {
      ...
      step1Desc:
        "Browse through our categories or search for the specific help you need.",
      step2Title: "Choose your Suki",
      step2Desc:
        "Compare profiles, read reviews from neighbors, and pick the one that fits your budget.",
      step3Title: "Book & Relax",
      step3Desc:
        "Schedule a date, pay securely, and enjoy high-quality results.",
    },
    cta: {
    ...
    footer: {
      desc: "The Philippines' most trusted marketplace for reliable local services and skilled professionals.",
      copyright:
        "© 2026 Lingkod Hub Philippines. Your trusted local service partner.",
    ...
    about: {
      ...
      valTrustDesc:
        "Every provider undergoes a verification process to ensure the community remains safe and professional.",
      valComm: "Community First",
      valCommDesc:
        "We prioritize local growth by connecting neighborhood experts with residents who need their skills.",
      valQuality: "Quality Service",
      valQualityDesc:
        "Our review system ensures that only the best services stay at the top, fostering excellence.",
      ...
      visionBadge: "Top Rated 2026",
      visionBadgeDesc:
        "Recognized as the fastest growing local service marketplace.",
      footerText: "© 2026 Lingkod Hub Philippines. All rights reserved.",
    },
    services: {
      headerTitle: "What service do you need today?",
      searchPlaceholder:
        "Search for a service (e.g. 'Aircon cleaning', 'Plumbing')",
      searchBtn: "Search",
      ...
      feat1Title: "Identity Verified",
      feat1Desc:
        "All partners undergo background and identity checks by local Barangay.",
      ...
      ctaDesc:
        "Post a custom request and let verified pros bid on your project. Fits your budget, fits your quality.",
    ...
    auth: {
      ...
      hireDesc:
        "I'm looking for professional services for my home or business.",
      workTitle: "Find Work",
      workDesc:
        "I want to offer my skills and earn money as a verified provider.",
      ...
      tosAgree:
        "I agree to the Terms of Service and understand platform policies.",
      tosLink: "Terms of Service",
...
export const LanguageProvider = ({ children }) => {
  ...
  const t = (section, key) => {
    return (
      ...
      translations["taglish"]?.[section]?.[key] ||
      key
    );
  };
